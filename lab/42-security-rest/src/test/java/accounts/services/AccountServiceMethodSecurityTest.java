...
class AccountServiceMethodSecurityTest {
	...
	@Test
	public void getAuthoritiesForUser_should_return_authorities_for_superadmin_from_admin() {

		ResponseEntity<String[]> authorities = restTemplate.withBasicAuth("superadmin", "superadmin")
				.getForEntity("/authorities?username=admin", String[].class);
		int hashCode = authorities.getStatusCodeValue();
		assertTrue(hashCode == 403);

	}
	
	@Test
	public void getAuthoritiesForUser_should_return_authorities_for_admin_from_superadmin() {

		ResponseEntity<String[]> authorities = restTemplate.withBasicAuth("admin", "admin")
